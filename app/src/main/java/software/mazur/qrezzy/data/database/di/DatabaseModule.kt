...
object DatabaseModule {
    @Provides
    @Singleton
    fun provideQrezzyDatabase(@ApplicationContext context: Context): QrezzyDatabase = Room
        .databaseBuilder(
            context = context,
